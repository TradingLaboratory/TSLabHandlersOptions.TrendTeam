...
{
    /// <summary>
    /// \~english Meta-information common to all smile nodes: time, price, risk-less rate.
    /// Also it contains continuous function which represents the smile.
    ...
    public class SmileInfo
    {
        ...
        public XElement ToXElement()
        {
            ...
            {
                var xContFunc = ContinuousFunction.ToXElement();
            ...
            {
                var xContFuncD1 = ContinuousFunctionD1.ToXElement();
